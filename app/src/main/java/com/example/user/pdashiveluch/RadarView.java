...
public class RadarView extends View {
    ...
    Point lpoint2[] = new Point[POINT_ARRAY_SIZE];
    Paint lpaint2[] = new Paint[POINT_ARRAY_SIZE];
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Paint smallcircle = lpaint2[0];
if (pda.place_radar==0)
{if (showCircles) {
            ...
            //canvas.drawCircle(i,i+25,  10,smallcircle);
        }}
        ...
        {if (showCircles) {
            ...
            canvas.drawCircle(i, i, j >> 1, localPaint);
            canvas.drawCircle(i, i, j >> 2, localPaint);
            canvas.drawCircle(i-pda.rnd1,i-pda.rnd2,  10,smallcircle);
        }}
